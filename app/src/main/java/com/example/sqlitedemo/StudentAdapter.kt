...
class StudentAdapter : RecyclerView.Adapter<StudentAdapter.StudentViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StudentViewHolder =
        StudentViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.card_item,parent,false))
    ...
    class StudentViewHolder(var view: View) : RecyclerView.ViewHolder(view){
        private var id = view.findViewById<TextView>(R.id.id_textview)
        private var name = view.findViewById<TextView>(R.id.name_textview)
        private var email = view.findViewById<TextView>(R.id.email_textview)
